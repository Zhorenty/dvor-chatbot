...
- Trainings domain/data:
 ...
 - `lib/src/data/dvor_team_repository.dart` (staff sheet `Тренерский штаб`, role `Команда DVOR`)
 - `lib/src/data/google_sheets_api_writer.dart` (bot-owned sheets `FUNNEL`, `АНАЛИТИКА`)
