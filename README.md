...
- Личка (пользовательский сценарий):
  ...
  - кнопка `Записать друга` — отдельный сценарий: выбрать событие, собрать состав (друг с Telegram / гость без Telegram / +себя), оплатить сумму `цена × число участников` одним чеком
